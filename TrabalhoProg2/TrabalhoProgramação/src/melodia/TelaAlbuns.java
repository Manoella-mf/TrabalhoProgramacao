...
public class TelaAlbuns extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquisa de Título:");
    ...
    private void btnCadastrarAlbumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarAlbumActionPerformed
        TelaCadastrarAlbum telaCadastrarAlbum = new TelaCadastrarAlbum(codigo);
    ...
    public void favoritarMusicas(){
        ...
        criarConexao();
        ManterAlbum favoritaAlbum = new ManterAlbum();
        
        String titulo = (String) cbAlbuns.getSelectedItem();
        System.out.println(titulo);
        favoritaAlbum.favoritar(con, titulo, true);
    ...
    public void desfavoritarMusicas(){
        ...
        String titulo = cbAlbuns.getName();
        favoritaAlbum.favoritar(con, titulo, false);
                
        encerrarConexao();
        
        //Exibir uma msg
        exibirMensagem("Álbum retirada dos favoritos com sucesso");   
    }
    ...
    public void listaAlbum(){
        ...
        for(String titulo : titulos){
            listAlbuns.append(titulo+"\n");
            cbAlbuns.addItem(titulo);
        }
        encerrarConexao();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAlbuns(codigo).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> cbAlbuns;
