...
public class TelaCadastrarAlbum extends javax.swing.JFrame {
     ...
     */
    private static Connection alb = null;
    static int codigo;
    ...
    public TelaCadastrarAlbum(int codigo) {
        this.codigo = codigo;
        initComponents();
    }
    ...
    public void cadastrarAlbum(){
        ...
        //Criar album
        Album novoAlbum = new Album(data, titulo, genero, false);
        ManterAlbum manter = new ManterAlbum();
        manter.inserir(alb, codigo, data, titulo , genero, false);
        encerrarConexao();
    ...
    public boolean validarCampos(){
        return !(txtTitulo.getText().isEmpty() || dtData.getText().isEmpty());
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastrarAlbum(codigo).setVisible(true);
            }
        });
    }
