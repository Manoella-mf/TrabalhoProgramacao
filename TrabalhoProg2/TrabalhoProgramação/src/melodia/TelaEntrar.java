...
//    private static ArrayList<Conta> perfil = new ArrayList();
    ...
    public void buscaDadosConta(){
       ...
       // String senhaAut;
        ...
        ManterConta buscaConta = new ManterConta(); 
        entrar = buscaConta.pesquisar(con, email, senha);
        if (entrar == true) {
                //Exibir uma mensagem de sucesso
                exibirMensagem("Login efetuado com sucesso!");
                limparDados();
                codigo = buscaConta.buscaConta(con, email, senha);
                entrarTelaMenu();
                return;
            } else {
                //Exibir uma mensagem de sucesso
    ...
    public void entrarTelaMenu(){
        TelaMenu telaMenu = new TelaMenu(codigo);
